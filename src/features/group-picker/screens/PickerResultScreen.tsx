...
export function PickerResultScreen({ result, activeLadderStart, revealedLadderStarts, revealAllQueue, setActiveLadderStart, revealAllLadderResults, prepareDraw, resetToSetup, onBackHome }: Pick<PickerController, 'activeLadderStart' | 'revealedLadderStarts' | 'revealAllQueue' | 'setActiveLadderStart' | 'revealAllLadderResults' | 'prepareDraw' | 'resetToSetup'> & { onBackHome: () => void } & { result: DrawResult }) {
